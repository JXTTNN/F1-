...
DRS_TRACK_DATA: dict[str, dict[str, Any]] = {
    ...
    "sakhir": {"n_drs_zones": 3, "avg_zone_length_m": 750.0},
    ...
    "spielberg": {"n_drs_zones": 3, "avg_zone_length_m": 500.0},
    "hungaroring": {"n_drs_zones": 2, "avg_zone_length_m": 600.0},
    "zandvoort": {"n_drs_zones": 2, "avg_zone_length_m": 700.0},
    ...
    "mexico_city": {"n_drs_zones": 3, "avg_zone_length_m": 566.7},
    "lusail": {"n_drs_zones": 1, "avg_zone_length_m": 800.0},
    "madrid": {"n_drs_zones": 3, "avg_zone_length_m": 600.0},
    "sao_paulo": {"n_drs_zones": 2, "avg_zone_length_m": 700.0},
